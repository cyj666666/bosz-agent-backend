...
public interface ReportService {
     ...
     *
     * <p><b>防重复（对齐行内口径）</b>：同一日检流水号下只挡<b>在途</b>记录
     * （111-待开始 / 000-进行中）—— 避免同流水号并发跑两份加工、版本号乱序。
     * <b>已完成（888）的不挡</b>：可以对着同一流水号再发起一次，按流水号自然堆出 V1、V2…；
     * 详情页仍按 checkTaskNo 取版本号最大的那版。想「基于上一版重跑」则走详情页「更新报告」。</p>
     *
