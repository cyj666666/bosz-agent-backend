...
('V2_BLK_CREDIT_R02', 'V2_CAT_06_CREDIT_01', 'TEXT', 'RULE', 'zxcxbzyxq', 'reportNo,entName', '征信查询不在有效期内', NULL, 'HIDE', NULL, 20, 1),
('V2_BLK_CREDIT_A03', 'V2_CAT_06_CREDIT_02', 'TEXT', 'ANALYSIS', 'zxqkmsqy', 'reportNo,entName', '征信情况描述', NULL, 'PLACEHOLDER', NULL, 10, 1),
('V2_BLK_CREDIT_R04', 'V2_CAT_06_CREDIT_02', 'TEXT', 'RULE', 'zhengxinyichang', 'reportNo,entName', '征信异常', NULL, 'HIDE', NULL, 20, 1),
('V2_BLK_CREDIT_A05', 'V2_CAT_06_CREDIT_03', 'TEXT', 'ANALYSIS', 'zwqkmsqy', 'reportNo,entName', '债务情况描述', NULL, 'PLACEHOLDER', NULL, 10, 1),
('V2_BLK_CREDIT_R06', 'V2_CAT_06_CREDIT_03', 'TEXT', 'RULE', 'zhaiwuyichang', 'reportNo,entName', '债务异常', NULL, 'HIDE', NULL, 20, 1),
('V2_BLK_CREDIT_R07', 'V2_CAT_06_CREDIT_04', 'TEXT', 'RULE', 'feiyinrz', 'reportNo,entName', '非银债务', NULL, 'HIDE', NULL, 10, 1),
('V2_BLK_CREDIT_R08', 'V2_CAT_06_CREDIT_04', 'TEXT', 'RULE', 'yinzurongzifs', 'reportNo,entName', '银租融资过于分散', NULL, 'HIDE', NULL, 20, 1),
('V2_BLK_CREDIT_R09', 'V2_CAT_06_CREDIT_04', 'TEXT', 'RULE', 'fyjgjgll', 'reportNo,entName', '存在非银机构较高利率借款', NULL, 'HIDE', NULL, 30, 1),
('V2_BLK_CREDIT_R10', 'V2_CAT_06_CREDIT_04', 'TEXT', 'RULE', 'ldyebh', 'reportNo,entName', '流贷余额变化', NULL, 'HIDE', NULL, 40, 1),
...
('V2_BLK_FUND_R04', 'V2_CAT_07_FUND_02', 'TEXT', 'RULE', 'gdjkwgh', 'reportNo,entName', '股东借款未归还', NULL, 'HIDE', NULL, 20, 1),
('V2_BLK_FUND_R05', 'V2_CAT_07_FUND_02', 'TEXT', 'RULE', 'stzfyc', 'reportNo,entName', '受托支付异常', NULL, 'HIDE', NULL, 30, 1),
...
('V2_BLK_GUARANTEE_R02', 'V2_CAT_11_GUARANTEE_01', 'TEXT', 'RULE', 'yapindywdcdy', 'reportNo,entName', '抵押物多次抵押', NULL, 'HIDE', NULL, 20, 1),
('V2_BLK_GUARANTEE_R03', 'V2_CAT_11_GUARANTEE_01', 'TEXT', 'RULE', 'yapinczxzql', 'reportNo,entName', '存在限制权利', NULL, 'HIDE', NULL, 30, 1),
...
('V2_BLK_GUARANTEE_R06', 'V2_CAT_11_GUARANTEE_02_01', 'TEXT', 'RULE', 'zxcxbzyxq', 'reportNo,entName,guarantorName', '征信查询不在有效期内', NULL, 'HIDE', NULL, 20, 1),
...
('V2_BLK_GUARANTEE_R08', 'V2_CAT_11_GUARANTEE_02_02', 'TEXT', 'RULE', 'zhengxinyichang', 'reportNo,entName,guarantorName', '征信异常', NULL, 'HIDE', NULL, 20, 1),
...
('V2_BLK_GUARANTEE_R10', 'V2_CAT_11_GUARANTEE_02_03', 'TEXT', 'RULE', 'zhaiwuyichang', 'reportNo,entName,guarantorName', '债务异常', NULL, 'HIDE', NULL, 20, 1),
('V2_BLK_GUARANTEE_R11', 'V2_CAT_11_GUARANTEE_02_04', 'TEXT', 'RULE', 'feiyinrz', 'reportNo,entName,guarantorName', '非银债务', NULL, 'HIDE', NULL, 10, 1),
('V2_BLK_GUARANTEE_R12', 'V2_CAT_11_GUARANTEE_02_04', 'TEXT', 'RULE', 'yinzurongzifs', 'reportNo,entName,guarantorName', '银租融资过于分散', NULL, 'HIDE', NULL, 20, 1),
('V2_BLK_GUARANTEE_R13', 'V2_CAT_11_GUARANTEE_02_04', 'TEXT', 'RULE', 'fyjgjgll', 'reportNo,entName,guarantorName', '存在非银机构较高利率借款', NULL, 'HIDE', NULL, 30, 1),
('V2_BLK_GUARANTEE_R14', 'V2_CAT_11_GUARANTEE_02_04', 'TEXT', 'RULE', 'ldyebh', 'reportNo,entName,guarantorName', '流贷余额变化', NULL, 'HIDE', NULL, 40, 1),
('V2_BLK_GUARANTEE_R15', 'V2_CAT_11_GUARANTEE_02_04', 'TEXT', 'RULE', 'dwdbjed', 'reportNo,entName,guarantorName', '对外担保金额大', NULL, 'HIDE', NULL, 50, 1),
...
('V2_BLK_GUARANTEE_R17', 'V2_CAT_11_GUARANTEE_02_05', 'TEXT', 'RULE', 'zxcxyxx', 'reportNo,entName,guarantorName', '征信查询不在有效期内', NULL, 'HIDE', NULL, 20, 1),
...
('V2_BLK_GUARANTEE_R19', 'V2_CAT_11_GUARANTEE_02_06', 'TEXT', 'RULE', 'zirenzhengxinyichang', 'reportNo,entName,guarantorName', '征信异常', NULL, 'HIDE', NULL, 20, 1),
...
('V2_BLK_GUARANTEE_R22', 'V2_CAT_11_GUARANTEE_02_08', 'TEXT', 'RULE', 'zhengxinchaxunyichang', 'reportNo,entName,guarantorName', '征信查询异常', NULL, 'HIDE', NULL, 20, 1),
('V2_BLK_GUARANTEE_R23', 'V2_CAT_11_GUARANTEE_02_09', 'TEXT', 'RULE', 'fyzwgr', 'reportNo,entName,guarantorName', '非银债务', NULL, 'HIDE', NULL, 10, 1),
('V2_BLK_GUARANTEE_R24', 'V2_CAT_11_GUARANTEE_02_09', 'TEXT', 'RULE', 'skrxldgr', 'reportNo,entName,guarantorName', '实控人学历低', NULL, 'HIDE', NULL, 20, 1),
('V2_BLK_GUARANTEE_R25', 'V2_CAT_11_GUARANTEE_02_09', 'TEXT', 'RULE', 'czfyjgglvgr', 'reportNo,entName,guarantorName', '存在非银机构较高利率借款', NULL, 'HIDE', NULL, 30, 1),
