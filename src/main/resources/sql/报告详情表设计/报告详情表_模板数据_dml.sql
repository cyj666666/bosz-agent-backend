...
--      例：客户基本情况 = 章节标题 → 正文 → 风险提示(工商受益人和系统实控人不一致) → 溯源按钮。
...
--   ⑦ AI 风险块与 mock 的 22 条风险 1:1（analysisType=RULE），ruleName 取自 mock 的 ruleName，
--      风险文案与解读由前置加工在实例层写入。
--
...
('BLK_SUM_04', 'CAT_01_SUMMARY', 'TEXT',  'ANALYSIS', 'AGT_TXT_SUM_02', NULL, NULL, 'PLACEHOLDER', 40,  1),
('BLK_SUM_05', 'CAT_01_SUMMARY', 'TEXT',  'ANALYSIS', 'AGT_TXT_SUM_03', NULL, NULL, 'PLACEHOLDER', 50,  1),
('BLK_SUM_06', 'CAT_01_SUMMARY', 'TEXT',  'ANALYSIS', 'AGT_TXT_SUM_04', NULL, NULL, 'PLACEHOLDER', 60,  1),
('BLK_SUM_07', 'CAT_01_SUMMARY', 'TEXT',  'ANALYSIS', 'AGT_TXT_SUM_05', NULL, NULL, 'PLACEHOLDER', 70,  1),
('BLK_SUM_08', 'CAT_01_SUMMARY', 'TITLE', NULL,       NULL,             NULL, 3,    'PLACEHOLDER', 80,  1),
('BLK_SUM_09', 'CAT_01_SUMMARY', 'TEXT',  'ANALYSIS', 'AGT_TXT_SUM_06', NULL, NULL, 'PLACEHOLDER', 90,  1),
...
('BLK_FIN_05',  'CAT_05_FINANCE', 'TEXT',        'ANALYSIS', 'AGT_TXT_FIN_03',    NULL,                               NULL, 'PLACEHOLDER', 60,  1),
('BLK_FIN_R02', 'CAT_05_FINANCE', 'TEXT',        'RULE',     'AGT_RULE_0004_FIN', '净利润过低及净利润快速下降',         NULL, 'PLACEHOLDER', 70,  1),
('BLK_FIN_06',  'CAT_05_FINANCE', 'TEXT',        'ANALYSIS', 'AGT_TXT_FIN_04',    NULL,                               NULL, 'PLACEHOLDER', 80,  1),
('BLK_FIN_R03', 'CAT_05_FINANCE', 'TEXT',        'RULE',     'AGT_RULE_0005_FIN', '费用率高',                           NULL, 'PLACEHOLDER', 90,  1),
('BLK_FIN_07',  'CAT_05_FINANCE', 'TEXT',        'ANALYSIS', 'AGT_TXT_FIN_05',    NULL,                               NULL, 'PLACEHOLDER', 100, 1),
('BLK_FIN_R04', 'CAT_05_FINANCE', 'TEXT',        'RULE',     'AGT_RULE_0006_FIN', '应收账款与其他应收款占比过高',       NULL, 'PLACEHOLDER', 110, 1),
('BLK_FIN_08',  'CAT_05_FINANCE', 'TEXT',        'ANALYSIS', 'AGT_TXT_FIN_06',    NULL,                               NULL, 'PLACEHOLDER', 120, 1),
('BLK_FIN_R05', 'CAT_05_FINANCE', 'TEXT',        'RULE',     'AGT_RULE_0007_FIN', '资产负债率偏离度高',                 NULL, 'PLACEHOLDER', 130, 1),
('BLK_FIN_09',  'CAT_05_FINANCE', 'TEXT',        'ANALYSIS', 'AGT_TXT_FIN_07',    NULL,                               NULL, 'PLACEHOLDER', 140, 1),
('BLK_FIN_R06', 'CAT_05_FINANCE', 'TEXT',        'RULE',     'AGT_RULE_0008_FIN', '经营现金流下降及营运周转放缓',       NULL, 'PLACEHOLDER', 150, 1),
('BLK_FIN_10',  'CAT_05_FINANCE', 'TEXT',        'ANALYSIS', 'AGT_TXT_FIN_08',    NULL,                               NULL, 'PLACEHOLDER', 160, 1),
...
('BLK_CRED_03',  'CAT_06_CREDIT', 'TEXT',        'ANALYSIS', 'AGT_TXT_CRED_02',    NULL,             NULL, 'PLACEHOLDER', 40,  1),
...
('BLK_FUND_03',  'CAT_07_FUND', 'TEXT',        'ANALYSIS', 'AGT_TXT_FUND_02',     NULL,                   NULL, 'PLACEHOLDER', 40,  1),
...
('BLK_SETT_08',  'CAT_09_SETTLEMENT', 'TITLE',       NULL,       NULL,                 NULL,               3,    'PLACEHOLDER', 90,  1),
('BLK_SETT_09',  'CAT_09_SETTLEMENT', 'TABLE',       NULL,       NULL,                 NULL,               NULL, 'PLACEHOLDER', 100, 1),
...
('BLK_GUAR_04',  'CAT_12_GUARANTEE', 'TITLE',       NULL,       NULL,                  NULL,             3,    'PLACEHOLDER', 50,  1),
('BLK_GUAR_05',  'CAT_12_GUARANTEE', 'TEXT',        'ANALYSIS', 'AGT_TXT_GUAR_02',     NULL,             NULL, 'PLACEHOLDER', 60,  1),
('BLK_GUAR_R02', 'CAT_12_GUARANTEE', 'TEXT',        'RULE',     'AGT_RULE_0022_GUAR',  '担保人债务异常',   NULL, 'PLACEHOLDER', 70,  1),
('BLK_GUAR_06',  'CAT_12_GUARANTEE', 'TEXT',        'ANALYSIS', 'AGT_TXT_GUAR_03',     NULL,             NULL, 'PLACEHOLDER', 80,  1),
